...
-ca giraph.workerContextClass=in.dreamlab.wicm.graph.mutations.WICMMutationsWorkerContextBackup \
-ca giraph.vertexResolverClass=in.dreamlab.wicm.graph.mutations.resolver.EATVertexResolverBackup \
...
-ca wantedlatency="$wantedlatency" \
-ca spillsize="$spillsize"
